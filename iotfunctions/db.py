...
class Database(object):
    ...
    def init_model_store(self, schema):
        self.schema = schema
        if self.model_store is None and self.entity_type_id is not None and self.schema is not None:
    ...
    def read_sql_query(self, sql, parse_dates=None, index_col=None, requested_col_names=None, log_message=None,
        ...
        try:
            ...
            raise RuntimeError(f"The new execution of the following sql statement failed: {sql}. Error: {str(ex)} ") from ex
        else:
